...
if ~isfield(gds, 'filecontent')
   errordlg('The current system was created using an older version of Matcont. This system needs to be regenerated. Please go the edit-system screen and press OK without changing the system, this will recompute the system in the new format');
