...
$key = q/NSEP1/;
$external_latex_labels{$key} = q|8.5.4|; 
$noresave{$key} = "$nosave";
...
$key = q/LPLCEP/;
$external_latex_labels{$key} = q|8.4.4|; 
$noresave{$key} = "$nosave";
...
$key = q/TSO/;
$external_latex_labels{$key} = q|3.4.10|; 
$noresave{$key} = "$nosave";

$key = q/labelAdapt/;
$external_latex_labels{$key} = q|3.4.9|; 
$noresave{$key} = "$nosave";
...
$key = q/LPEP/;
$external_latex_labels{$key} = q|8.1.5|; 
$noresave{$key} = "$nosave";
...
$key = q/Catal2/;
$external_latex_labels{$key} = q|8.2.5|; 
$noresave{$key} = "$nosave";
